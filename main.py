...
class LinkExtractorApp(ctk.CTk):
    ...
    def _build_settings_screen(self) -> ctk.CTkFrame:
        ...
        self.jd_port_entry = ctk.CTkEntry(
            jd_row,
            width=100, height=36,
            font=ctk.CTkFont(family=m3.FONT_TEXT, size=12),
            border_color=m3.OUTLINE,
        ...
        self.jd_port_entry.insert(0, str(self.settings.get("jd_port", 9666)))
        self.jd_port_entry.bind("<KeyRelease>", lambda e: self._save_current_settings())
        self.jd_port_entry.pack(side="right")
